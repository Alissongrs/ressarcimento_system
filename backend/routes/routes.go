...
func SetupRouter(gdb *gorm.DB) *gin.Engine {
	...
	apiV1 := r.Group("/api/v1")
	{
		...
		authRequired.Use(middleware.AuthMiddleware())
		{
			...
			authRequired.GET("/faturas/anotacoes-campo", handlers.GetAnotacoesCampo)
			authRequired.GET("/faturas/ficha/06", handlers.ListFicha06)
			authRequired.GET("/faturas/ficha/07", handlers.ListFicha07)
			authRequired.GET("/faturas/ficha/08", handlers.ListFicha08)
			authRequired.GET("/faturas/ficha/09", handlers.ListFicha09)
			authRequired.GET("/faturas/ficha/10", handlers.ListFicha10)
			authRequired.GET("/faturas/ficha/11", handlers.ListFicha11)
			authRequired.GET("/faturas/ficha/12", handlers.ListFicha12)
			authRequired.GET("/faturas/ficha/13", handlers.ListFicha13)
			authRequired.GET("/faturas/ficha/14", handlers.ListFicha14)
			...
			authRequired.POST("/faturas/decisao", handlers.PATCHFaturaDecisao)
			...
			authRequired.POST("/ia/testar-prompt", handlers.TestarPromptHandler)
			authRequired.POST("/ia/analisar-fatura/:id", handlers.AnalisarFaturaRegrasHandler)
			authRequired.POST("/ia/arbitrar-fatura/:id", handlers.ArbitrarFaturaHandler)

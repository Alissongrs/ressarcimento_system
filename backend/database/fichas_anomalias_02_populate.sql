-- =============================================================================
-- fichas_anomalias_02_populate.sql
--
-- EXECUTAR COMO: alisson_rodrigues  (user com SELECT em sgeeasy_clientes_novo
--                                    E INSERT em db_ressarcimento)
-- BANCO CONTEXTO: qualquer um — as tabelas são referenciadas com prefixo de banco
--
-- Pode ser reexecutado a qualquer momento para atualizar o cache.
-- =============================================================================

INSERT INTO db_ressarcimento.fichas_anomalias_cache
...
SELECT CONCAT('Sincronização concluída: ', ROW_COUNT(), ' linhas afetadas.') AS status;
